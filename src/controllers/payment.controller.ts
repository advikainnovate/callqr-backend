...
import { SUBSCRIPTION_PLANS, SUBSCRIPTION_PRICES_DISPLAY } from '../constants/subscriptions';
...
export class PaymentController {
  ...
  getPlans = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    sendSuccessResponse(res, 200, 'Subscription plans retrieved successfully', { plans });
  });
  ...
  verifyPayment = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    sendSuccessResponse(res, 200, 'Payment verified and subscription activated', {
   ...
   */
  paymentFailed = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
