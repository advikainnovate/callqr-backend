...
export const users = pgTable('users', {
  ...
  isPhoneVerified: varchar('is_phone_verified', { length: 10 }).notNull().default('false'), // Phone verification status
  isGloballyBlocked: varchar('is_globally_blocked', { length: 10 }).notNull().default('false'), // Global block flag
